...
#    Version: 0.0.0.0
#
#    Description: Report parser for: tcv_municipal_tax_wh
#
#
##############################################################################
#~ import time
...
##------------------------------------------------- parser_tcv_municipal_tax_wh

class parser_tcv_municipal_tax_wh(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context=None):
        context = context or {}
        super(parser_tcv_municipal_tax_wh, self).__init__(
...
report_sxw.report_sxw(
    'report.tcv.municipal.tax.wh.report',
    'tcv.municipal.tax.wh',
    'addons/tcv_municipal_tax/report/tcv_municipal_tax_wh.rml',
    parser=parser_tcv_municipal_tax_wh,
    header=False
    )
