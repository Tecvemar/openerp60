...
##------------------------------------------ tcv_mrp_supplies_by_product_wizard


class tcv_mrp_supplies_by_product_wizard(osv.osv_memory):

    _name = 'tcv.mrp.supplies.by.product.wizard'
    ...
    def default_get(self, cr, uid, fields, context=None):
        data = super(tcv_mrp_supplies_by_product_wizard, self).\
