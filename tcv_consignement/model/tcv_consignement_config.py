...
##------------------------------------------------------ tcv_consignement_config


class tcv_consignement_config(osv.osv):

    _name = 'tcv.consignement.config'
    ...
    _columns = {
        ...
        'stock_location_id': fields.many2one(
            ...
            readonly=False, required=True, ondelete='restrict',
            help="Destination location for material placed on consignement"),
