...
##------------------------------------------------------ parser_tcv_sale_top_10


#~ class parser_tcv_sale_top_10(report_sxw.rml_parse):
#~
    #~ def __init__(self, cr, uid, name, context=None):
        #~ context = context or {}
        #~ super(parser_tcv_sale_top_10, self).__init__(
...
#~ report_sxw.report_sxw(
    ...
    #~ 'tcv.sale.top.10',
    #~ 'addons/tcv_sale_top_10/report/tcv_sale_top_10.rml',
    #~ parser=parser_tcv_sale_top_10,
    #~ header=False
    #~ )
