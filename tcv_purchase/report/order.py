...
class tcv_order(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(tcv_order, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.tcv.purchase.quotation',
                      'purchase.order',
                      'addons/tcv_purchase/report/order.rml',
                      parser=tcv_order)

report_sxw.report_sxw('report.tcv.purchase.order',
                      'purchase.order',
                      'addons/tcv_purchase/report/order.rml',
                      parser=tcv_order)
